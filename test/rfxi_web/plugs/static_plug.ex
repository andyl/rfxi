defmodule RfxiWeb.StaticPlug.File do
  @moduledoc false
...
defmodule RfxiWeb.StaticPlug.Provider do
  @moduledoc false
  ...
  """
  @callback get_file(segments(), compression()) :: RfxiWeb.StaticPlug.File.t() | nil
...
defmodule RfxiWeb.StaticPlug do
  @moduledoc false
  ...
  # ## Options
  #
  # * `:file_provider` (**required**) - a module implementing `RfxiWeb.StaticPlug.Provider`
