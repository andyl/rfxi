defmodule RfxiWeb.MemoryProvider do
  @moduledoc false
  ...
  defmacro __using__(opts) do
    quote bind_quoted: [opts: opts] do
      ...
      paths = RfxiWeb.MemoryProvider.__paths__(static_path)
      files = RfxiWeb.MemoryProvider.__preload_files__!(static_path, paths, opts)
      ...
      def __mix_recompile__? do
        current_paths = RfxiWeb.MemoryProvider.__paths__(unquote(static_path))
  ...
  def __preload_files__!(static_path, paths, opts) do
    ...
    Enum.map(paths, fn path ->
      ...
      if gzip? and Path.extname(path) in @gzippable_exts do
        ...
        {segments, :gzip, %RfxiWeb.StaticPlug.File{content: gzipped_content, digest: digest}}
      else
        {segments, nil, %RfxiWeb.StaticPlug.File{content: content, digest: digest}}
      end
    end)
  end
